	...
	<div id="main-wrapper">
		...
		<div class="wrapper-pad">
			...
			<div id="table-head">
				...
				<?php
				if ($role == 1 || $role == 2) {
					echo '<a href="" name="delete-all" class="btn red disabled fright"><i class="fas fa-trash"></i> Eliminar </a>';
				}
				?>
				<a href="" name="check-out-all" class="btn blue disabled fright"><i class="fas fa-arrow-up"></i> Salidas </a>
				<a href="" name="check-in-all" class="btn green disabled fright"><i class="fas fa-arrow-down"></i> Entradas </a>
			<?php
			if($c_items == 0)
